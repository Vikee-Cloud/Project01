        ...
        var n = (j == null ? void 0 : j.m) || [],
            o = function(b) {
                T((j == null ? void 0 : j.r) || [], {
                    ...
                    onAll: function() {
                        return E.registerCallback(function() {
                            E.notify(E.tierThreeStart(a)), e.call(null, n.map(c("RequireDeferredReference").getRDModuleName_DO_NOT_USE), function() {
...
__d("FalcoLoggerInternal", ["AnalyticsCoreData", "BaseEventEmitter", "FBLogger", "FalcoConsentChecker", "FalcoUtils", "ODS", "PersistedQueue", "Promise", "Random", "ServerTime", "nullthrows", "performanceAbsoluteNow"], (function(a, b, c, d, e, f, g) {
    ...
    var h, i, j, k, l = d("FalcoUtils").getTaggedBitmap(33),
        m = d("FalcoUtils").getTaggedBitmap(0),
        n = 500 * 1024 * .6,
        o = "ods_web_batch",
        p = new Map(),
        q = new Set(["cmcd_messenger_web_logging_event", "javascript_web_error", "comet_redblock"]);
    ...
    function a(a, b) {
        ...
        return c("nullthrows")(p.get(a + "^$" + b))
    }
    f = d("FalcoUtils").identityToString((k || (k = c("AnalyticsCoreData"))).identity);
    var s = a("falco_queue_log", f),
        t = a("falco_queue_immediately", f),
        u = a("falco_queue_critical", f),
        v = new(c("BaseEventEmitter"))(),
        w = new(c("BaseEventEmitter"))();
    ...
    function A(a, b) {
        ...
        b = b.c;
        b != null && (k || (k = c("AnalyticsCoreData"))).consents != null && (d = d && B(b, (k || (k = c("AnalyticsCoreData"))).consents, a));
        return d
    }

    function B(a, b, d) {
        var e = z[a];
        e == null && (e = z[a] = JSON.parse(a));
    ...
    function E(a, b, d, e, f, g) {
        if ((k || (k = c("AnalyticsCoreData"))).enable_cmcd_observer && !q.has(a)) {
            a = babelHelpers["extends"]({
                name: a,
                time: b,
                sampled: d,
    ...
    function F(a, b, e, f, g, h) {
        g = JSON.stringify(g);
        if (g.length > n) {
            y(a, "js.drop.oversized_message", 1, !0);
        ...
        h.wrapAndEnqueueItem({
            ...
            extra: g,
            privacyContext: f,
            tags: d("FalcoUtils").xorBitmap([0, 0], m)
        });
        y(a, "js.event.write_to_queue", 1, !0)
    }
...
__d("react-forget-runtime", ["fb-error", "gkx"], (function(a, b, c, d, e, f, g) {
    ...
    function b(a) {
        c = a.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher
    }
    g.$dispatcherGuard = a;
...
__d("FalcoLoggerTransports", ["AnalyticsCoreData", "Banzai", "ExecutionEnvironment", "FBLogger", "FalcoAppUniverse", "FalcoUtils", "ODS", "PersistedQueue", "Queue", "WebSession", "performanceAbsoluteNow", "promiseDone", "requireDeferredForDisplay", "uuidv4"], (function(a, b, c, d, e, f, g) {
    ...
    function Z(a) {
        var b, d = a.name;
        if (!M() || !F) return !1;
        if (w.has(d) || a.policy.s !== 1 && ((b = (i || (i = c("AnalyticsCoreData"))).br_stateful_migration_on) != null ? b : !1)) {
            a.shouldAddState = !0;
            return !0
        }
